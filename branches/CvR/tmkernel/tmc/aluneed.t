...
.set    class_list ds cmp new fre rfre rdup print fprint fscan
.append class_list append concat slice setroom insert delete reverse extract
...
..
.. ** reverse **
.set need_ds_list ${uniq $(need_ds_list) $(need_reverse_list)}
..
.. ** insert **
...
..
.. ** delete **
.set need_rfre_list ${uniq $(need_rfre_list) $(need_delete_list)}
