...
&
Return word \texttt{w} made to length \texttt{len} either by truncation or padding
at the end with copies of \texttt{pw}.
\\
...
&
Return the index of the first occurrence of character \texttt{c} in word \texttt{w},
counting from 1, or 0 if \texttt{c} does not occur in \texttt{w}.
\\
