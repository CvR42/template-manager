...
This directory contains the Tm C support templates, plus some files to test
them.  Please read this file before installing the program.
...
found in the directory . Please install these before you try to compile
the test programs. Alternatively, you can use the Makefile in
...
See the section ``Compiling and installing on MS-Windows'' for compilation
and installation on this system.
