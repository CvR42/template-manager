...
\\
{\tt processortime}\index{dsfilename@{\tt dsfilename}}
&
...
\\
{\tt reach t..t}\index{reach@{\tt reach}}
&
Given a list of types {\tt t}, return all types that can be reached from
these types. The \defn{direct reach} of a class, tuple, constructor
...
\par
The \defn{reach} of a type is the union of the type itself, the direct reach of
the type, and the reach of the types in the direct reach of the type.
Thus, the reach is the transitive closure of the direct reach.
\\
\end{desctab}
For example:
\begin{showfile}
