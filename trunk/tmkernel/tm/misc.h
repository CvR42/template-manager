...
extern void collect_subclasses( tmstring_list *res, const ds_list types, const_tmstring type );
extern void collect_superclasses( tmstring_list *res, const ds_list types, const char *type );
extern void collect_inheritors( tmstring_list *res, const ds_list types, const_tmstring type );
