\chapter{C support}
\label{s.tmc}
This chapter a detailed description of the {\C} templates is given.
...
In {\C}, {\Tm} types and type lists are pointers
...
of the same type.
This mechanism is called \defn>{caching}.
...
This process is called \defn>{caching},
and the array is called the \defn>{cache}.
...
\\
\end{desctab}
\section{Old Tm templates}
Next to the {\C} template described above, there are three variants of of old
templates,
...
\end{tabular}
\end{flushleft}
The functionality they provide is similar to that of the new
templates, but their support for classes and inheritance is limited.
