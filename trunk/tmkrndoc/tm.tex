...
A case statement may contain any number of words, including 0.
There can be at most one \verb'.default' section. Note that more than
one case can be executed.
\par
For example:
...
\\
{\tt fields t [inherited]}\index{fields@{\tt fields}}
&
Given a type {\tt t},
return the list of field names of that type.
Only tuple, constructor and class types may have fields; for a
constructor base type an empty list is returned.
\par
...
superclasses. Since a constructor base type may inherit from any type,
it may also have fields now.
\\
...
\\
{\tt metatype t}\index{metatype@{\tt metatype}}
&
...
has the prefix {\tt listpre} and the suffix {\tt listsuff}, return {\tt
list}; in all other cases return {\tt atom}.
\\
...
{\tt type}.
\\
{\tt typeclass t e}\index{typeclass@{\tt typeclass}}
&
...
\\
{\tt inheritors t}\index{inheritors@{\tt inheritors}}
&
Given a type {\tt t},
...
\\
{\tt superclasses t}\index{superclasses@{\tt superclasses}}
&
Given a type {\tt t}, return the list of types this type inherits directly
or indirectly.
\\
...
information about the data structure file that was passed to {\Tm}.
They have been replaced by the functions in the previous section,
